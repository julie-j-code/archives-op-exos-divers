...
<body>
    ...
    try {
        $bdd = new PDO('mysql:host=localhost;dbname=DB3848654', 'U3848654', 'xTuxGfRNgB5kWBQ');
        //$bdd = new PDO('mysql:host=rdbms.strato.de;dbname=minichat;charset=utf8', 'U3848654', 'xTuxGfRNgB5kWBQ');
    } catch (Exception $e) {
...
</html>The way she moves, she's like a belly-dancer. She's shaking that ass to the new Nelly jams. I think someone's at the door but I don't think I'mma answer. Police saying 'freeze!': do-doing, doing, doing. What do you mean, 'freeze'? Please, I'm a human being!. I have needs! I'm NOT done, not 'til I'm finished peeing.